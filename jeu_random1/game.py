...
class Game:
    ...
    def __init__(self):
        ...
        tmx_data = pytmx.util_pygame.load_pygame('College\jeu_random1\carte.tmx')
    ...
    def switch_house(self):
        #charger la carte (tmx)
        tmx_data = pytmx.util_pygame.load_pygame('College\jeu_random1\house.tmx')
        map_data = pyscroll.data.TiledMapData(tmx_data)
        map_layer = pyscroll.orthographic.BufferedRenderer(map_data, self.screen.get_size())
        map_layer.zoom = 2
    ...
    def switch_world(self):
        ...
        #recup point de spawn devant maison
